...
export default function TransactionCard({ transaction: tx, currentUserId, categories, members }: Props) {
          ...
          {isOwner && (
            <>
              <button
                ...
                disabled={isPending}
                className="text-xs px-2 py-1 rounded-lg text-gray-300 hover:text-blue-400 transition-colors"
              >
                ✎
              </button>
              <button
